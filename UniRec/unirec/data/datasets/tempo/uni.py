...
from unirec.data.datasets.tempo import TempoDataset
from unirec.utils.tempo import ts_to_high_level_tempo


class unirecDataset(TempoDataset):
    def __init__(self, params):
        super(unirecDataset, self).__init__(params)
        self._gen_fism()
    ...
    def _gen_fism(self, n_epochs=300):
        ...
        for ep in range(n_epochs):
            if fism_sampling != 'uniform':
                ...
                fism_name = f'fism_nitems{n_items}_' \
                            ...
                            f'{fism_sampling}-sampling_' \
                            f'ep{ep}.pkl'
            fism_path = os.path.join(tempo_data_path, fism_name)
