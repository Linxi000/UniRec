...
from unirec.data.loaders.train_loader import TrainDataLoader
from unirec.data.loaders.test_loader import TestDataLoader
...
def dataloader_factory(data, batch_size, seqlen, mode='train',
                       ...
                       threshold_favs=1.0,
                       threshold_user=1.0,
                       neg_sampling='uniform',sim_path='',data_name='',
    ...
    kwargs['item_similarity'] = data['item_similarity']
    kwargs['item_uni'] = data['item_uni']
    kwargs['user_uni'] = data['user_uni']
    kwargs['item_head_tail'] = data['item_head_tail']
    kwargs['item_neighbors'] = data['item_neighbors']
    kwargs['item_var'] = data['item_var']
    kwargs['frac'] = frac
